                    ...
                    <div class="flex justify-center mt-20">
                        ...
                        <form action="/questionnaires/{{$questionnaire->idquestionnaire}}/questions" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input name="question[question]" type="text" class="appearance-none block w-full bg-gray-200 text-gray-700 border border-red-500 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white"
                                    ...
                                    <div>
                                        ...
                                        <div class="form-group mt-4">
                                            ...
                                            <input name="reponse[][reponse]" type="text" value="{{old('reponse.0.reponse')}}"
                                                class="appearance-none block w-full bg-gray-200 text-gray-700 border border-red-500 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="answers1" aria-describedby="choiceHelp"
                                    ...
                                    <div>
                                        ...
                                        <div class="form-group mt-4">
                                            ...
                                            <input name="reponse[][reponse]" type="text" value="{{old('reponse.1.reponse')}}"
                                                class="appearance-none block w-full bg-gray-200 text-gray-700 border border-red-500 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="reponse2" aria-describedby="choiceHelp"
                                    ...
                                    <div>
                                        ...
                                        <div class="form-group mt-4">
                                            ...
                                            <input name="reponse[][reponse]" type="text" value="{{old('reponse.2.reponse')}}"
                                                class="appearance-none block w-full bg-gray-200 text-gray-700 border border-red-500 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="reponse3" aria-describedby="choiceHelp"
                                    ...
                                    <div>
                                        ...
                                        <div class="form-group mt-4">
                                            ...
                                            <input name="reponse[][reponse]" type="text" value="{{old('reponse.3.reponse')}}"
                                                class="appearance-none block w-full bg-gray-200 text-gray-700 border border-red-500 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="reponse4" aria-describedby="choiceHelp"
